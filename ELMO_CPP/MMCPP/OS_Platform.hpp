...
#define OS_PLATFORM_HPP_
    ...
    #include "MMCPP/OS_PlatformLinuxIpc32.hpp"
    
#elif (OS_PLATFORM == WIN32_PLATFORM)
    #include "MMCPP/OS_PlatformWin32.hpp"
    
#elif (OS_PLATFORM == WIN64_PLATFORM)
    #include "MMCPP/OS_PlatformWin64.hpp"
    
#elif (OS_PLATFORM == LINUXRPC32_PLATFORM)
    #include "MMCPP/OS_PlatformLinuxRpc32.hpp"
    
#elif (OS_PLATFORM == LINUXRPC64_PLATFORM)
    #include "MMCPP/OS_PlatformLinuxRpc64.hpp"
    
#elif (OS_PLATFORM == VXWORKS32_PLATFORM)
    #include "MMCPP/OS_PlatformVxWorks32.hpp"
