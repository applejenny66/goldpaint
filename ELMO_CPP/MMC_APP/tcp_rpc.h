...
int MMC_CreateRpcConnect(IN MMC_IF_STRUCT* pMmcIf,IN ELMO_PINT8 pSockPath, ELMO_UINT16 usPort, ELMO_PINT8 cpHostIPAddr);

int MMC_CloseRpcConnect (IN MMC_IF_STRUCT* pMmcIf);
