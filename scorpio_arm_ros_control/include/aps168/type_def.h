...
typedef struct {
    I16 drive;                  // �X�ʤ�(���e�X�ߪi)�ɬ�1

    I16 sw_limit_plus_stop;     // �]��F�����Ӱ���ɬ�1
    I16 sw_limit_minus_stop;    // �P�W
    I16 ELP_stop;               // �P�W
    I16 ELM_stop;               // �P�W
    I16 ALM_stop;               // �]servo alarm�Ӱ���ɬ�1
    I16 emergency_stop;         // �]emergency_stop�Ӱ���ɬ�1
    I16 home_search_error_stop; // �^���I�����~����ɬ�1
    I16 ORG_stop;               // �]ORG�Ӱ���ɬ�1
    I16 EZ_stop;                // �]EZ�Ӱ���ɬ�1

    I16 ORG;                    // �H�U��ORG���T����high/low���A
    I16 EZ;                           
    I16 INP;
    I16 ALM;
    I16 ELP;
...
typedef struct //emx
{
	I32 VS;         // start velocity ,range 1 ~ 4,000,000
	I32 Vmax;       // Maximum  velocity ,range 1 ~ 4,000,000
	I32 Acc;        // Acceleration ,range 1 ~ 500000000
	I32 Dec;        // Deceleration ,range 1 ~ 500000000
	F64 s_factor;	// range 0 ~ 10
} Speed_profile;
...
typedef struct 
{
    ...
    I32   TotalAxisNum;
    I32   Axis_ID[64];
	I32   Axis_ID_manual[64];
    I32   DI_ModuleNum;
    I32   DI_ModuleType[32];
	I32   DO_ModuleNum;
    I32   DO_ModuleType[32];
	I32   AI_ModuleNum;
    I32   AI_ModuleType[32];
	I32   AO_ModuleNum;
    I32   AO_ModuleType[32];
    char  Name[128]; 
