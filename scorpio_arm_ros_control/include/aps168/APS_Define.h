...
#define	LINUX_ENIPATH	"Card_0_ADLINK_Config2.xml"
...
#define PRA_PLS_IPT_DIR_PIN (0x87)
#define PRA_PLS_OPT_DIR_PIN (0x88)
...
#define PRA_HOME_Search_Target		(0x1D)  // Select Home move search target signal
#endif
