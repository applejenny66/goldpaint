...
def add_obj(self):
     ...
     box_name = "areaC_box"
     scene.add_box(box_name, box_pose, size=(0.6, 1.0, 0.729))
...
if __name__ == '__main__':
  rospy.init_node('attacking_packagearea_pose')

  pose_srv = rospy.Service('attacking_packagearea_pose', PoseSrv, planner)
